...
?>
	...
	<section class="investment-phylo-area">

		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 order-xl-1 order-lg-1 order-md-2 order-last">
				...
				<div class="col-lg-6 order-xl-2 order-lg-2 order-md-1 order-first">
