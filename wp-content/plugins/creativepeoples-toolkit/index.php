...
final class Cp_Toolkit_Extenstion {
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/decade-service.php');  
		require_once( __DIR__ . '/widgets/mission.php');  
		require_once( __DIR__ . '/widgets/learn-more.php');  
		require_once( __DIR__ . '/widgets/how-to-work.php');  
		require_once( __DIR__ . '/widgets/about-more.php');  
		require_once( __DIR__ . '/widgets/office-overview.php');  
		require_once( __DIR__ . '/widgets/clients.php');  
		require_once( __DIR__ . '/widgets/our-advisor.php');    
		require_once( __DIR__ . '/widgets/get-in-tuch.php');    
		require_once( __DIR__ . '/widgets/send-message.php');    
		require_once( __DIR__ . '/widgets/g-map.php');    
		require_once( __DIR__ . '/widgets/custom-blockqoute.php');    
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \decare_service_Section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \mission_Section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \learn_more_Section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \how_to_work_Section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \About_more_Section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \office_overview_Section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \client_section_Widget() );  
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \our_advisor_section_Widget() );   
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \get_in_tuch_Widget() );   
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Send_Message_Section_Widget() );   
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \gmap_section_Widget() );   
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \custom_blockqoute_Widget() );   
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Service_list_Section_Widget() );   
